...
/**
 * Même flux en 3 étapes que useDriverPhotoUpload (upload-url signée,
 * envoi au stockage, confirmation), pour le côté client — recadrage
 * carré imposé, adapté à un avatar.
 */
