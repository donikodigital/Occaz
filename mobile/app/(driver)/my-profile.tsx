// mobile/app/(driver)/my-profile.tsx
// [23/09/2026] v9 — Déplacé depuis l'onglet Profil (devenu un menu, voir
// (tabs)/profile.tsx) : ne montre plus que la fiche détaillée. « Mes
// litiges » et la déconnexion ont suivi vers le menu. La palette locale
// OCEAN dupliquée est remplacée par celle partagée (@/theme/ocean), pour
// ne plus avoir deux bleus à maintenir séparément.
// [21/09/2026] — StyleSheet.absoluteFillObject remplacé par absoluteFill (retiré des versions récentes de React Native).
...
import { OCEAN as SHARED_OCEAN } from '@/theme/ocean';
import { useAuthStore } from '@/stores/authStore';
import { useDriverProfile } from '@/hooks/useDriverProfile';
import { useMyVehicles } from '@/hooks/useVehicles';
import type { Vehicle } from '@/types/vehicles.types';

// Complète la palette partagée avec les quelques teintes propres à cet
// écran (mistBorder, field, ink) qu'elle ne définit pas — mêmes valeurs
// qu'avant, juste plus de doublon sur deep/base/bright/sky/mist/gold.
const OCEAN = {
  ...SHARED_OCEAN,
  mistBorder: '#D3E8F4',
  field: '#F3F8FC',
  ink: '#0B2A44',
  white: SHARED_OCEAN.onDark,
} as const;
...
export default function MyDriverProfileScreen() {
